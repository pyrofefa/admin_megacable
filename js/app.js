...
rutas.config(function($routeProvider) {
    ...
    $routeProvider
        ...
        .when('/ruleta', {
            templateUrl : 'view/ruleta.html',
            controller  : 'ruletaController'
        })
        .when('/ruleta/update/:param', {
            templateUrl : 'view/update_ruleta.html',
            controller  : 'update_ruletaController'
        })
        /*final*/  
        .otherwise({
            redirectTo: '/'
...
{});
rutas.controller('ruletaController',['$scope', 'imagen', '$http', function ($scope, imagen, $http)
{
    $http({
        method:"get",
...
rutas.controller('update_ruletaController',['$scope', '$http', '$routeParams', function($scope, $http, $routeParams) 
{
    ...
    $scope.agregar_ruleta=function()
    {
        if ($scope.miFormulario.$valid) 
        {
            ...
            $http({
                ...
                alert("Datos actualizados con exito");
                window.location.href="#/ruleta";                //console.log(id);
            })
        }    
    }
   ...
   $http({
        ...
        $scope.agregar_banner_footer = function()
        {
            ...
            $http({
                ...
                data: ({'nombre' : nombre , 'ruta' :  directorio, 'descripcion' : descripcion, 'tipo' : tipo })
            }).success(function(data){
                alert("Datos guardados con exito");
...
rutas.controller('update_paquetesController', ['$scope', 'imagen', '$http','$routeParams', function ($scope, imagen, $http, $routeParams) 
{
